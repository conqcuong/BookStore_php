            ...
            <section className='max-w-[1100px] w-full mx-auto p-0 md:w-[644px]'>
                <div className='flex mx-[-12px] md:mx-[-8px] md:flex-wrap sm:flex-wrap sm:mx-[-4px]'>
                    ...
                    <div className="block w-1/6 px-3 md:w-2/6 md:px-2 sm:w-full sm:px-1">
                        <div className="flex justify-start lg:justify-center">
                            <div>
                                <h2 className="text-[18px] leading-4 uppercase mt-2.5 mb-[15px] font-semibold text-[#fff] sm:mt-9">VỀ STORE</h2>
                                <ul className="my-2.5">
                                    {list_f8.map((e, i) => (
                    ...
                    <div className="block w-1/6 px-3 md:w-2/6 md:px-2 sm:w-full sm:px-1">
                        <div className="flex justify-start lg:justify-center">
                            <div>
                                <h2 className="text-[18px] leading-4 uppercase mt-2.5 mb-[15px] font-semibold text-[#fff] sm:mt-9">DỊCH VỤ</h2>
                                <ul className="my-2.5">
                    ...
                    <div className="block w-1/6 px-3 md:w-2/6 md:px-2 sm:w-full sm:px-1">
                        <div className="flex justify-start lg:justify-center">
                            <div>
                                <h2 className="text-[18px] leading-4 uppercase mt-2.5 mb-[15px] font-semibold text-[#fff] sm:mt-9">HỖ TRỢ</h2>
                                <ul className="my-2.5">
                                    {tools_list.map((e, i) => (
                                        <li className='mb-2 text-14px' key={i}>
                                            <Link className='text-[#a9b3bb]' to={e.path}>{e.text}</Link>
                    ...
                    <div className="block w-full px-3">
                        <div className='flex mt-12 sm:flex-col'>
                            ...
                            <div className="flex ml-auto sm:mt-3 sm:ml-0">
                                <Link to=''><FaSquareYoutube className='text-[#eb2c3b] text-[32px]'/></Link>
                                <Link to=''><FaSquareFacebook className='text-[#4867aa] text-[32px] mx-[16px]'/></Link>
                                <Link to=''><FaTiktok className='text-[#ccc] text-[32px]'/></Link>
                            </div>
                        </div>
                    </div>
                </div>
